...
use OOS\Model\ListKeyInfo;
use OOS\Model\ListMultipartUploadInfo;
use OOS\Model\ListPartsInfo;
use OOS\Model\LoggingConfig;
use OOS\Model\ObjectInfo;
use OOS\Model\ObjectListInfo;
use OOS\Model\WebsiteConfig;
use OOS\Result\AclResult;
use OOS\Result\AppendResult;
use OOS\Result\CallbackResult;
use OOS\Result\CompleteMultipartUploadResult;
use OOS\Result\CopyObjectResult;
use OOS\Result\CreateAccessKeyResult;
use OOS\Result\DeleteObjectsResult;
use OOS\Result\DeleteUpdateAccessKeyResult;
use OOS\Result\ExistResult;
use OOS\Result\GetAccelerateResult;
use OOS\Result\GetCorsResult;
use OOS\Result\GetLifecycleResult;
use OOS\Result\GetLocationResult;
use OOS\Result\GetLoggingResult;
use OOS\Result\GetObjectResult;
use OOS\Result\GetPolicyResult;
use OOS\Result\GetWebsiteResult;
use OOS\Result\HeaderObjectResult;
use OOS\Result\HeaderResult;
use OOS\Result\InitiateMultipartUploadResult;
use OOS\Result\ListAccessKeyResult;
use OOS\Result\ListBucketsResult;
use OOS\Result\ListMultipartUploadResult;
use OOS\Result\ListObjectsResult;
use OOS\Result\ListPartsResult;
use OOS\Result\PutSetDeleteResult;
use OOS\Result\RegionsResult;
use OOS\Result\UploadPartResult;
